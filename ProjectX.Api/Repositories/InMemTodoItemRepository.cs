...
namespace ProjectX.Api.Repositories
{
    ...
    public class InMemTodoItemRepository : IInMemTodoItemRepository
    {
        ...
        {
            new TodoItem { Id = Guid.NewGuid(), Name = "Apple", Todo = "Don't do any thing", TodoDateTime = DateTimeOffset.UtcNow },
            new TodoItem { Id = Guid.NewGuid(), Name = "Bat", Todo = "Do any thing", TodoDateTime = DateTimeOffset.UtcNow },
            new TodoItem { Id = Guid.NewGuid(), Name = "Cat", Todo = "Do Something thing", TodoDateTime = DateTimeOffset.UtcNow },
        };
